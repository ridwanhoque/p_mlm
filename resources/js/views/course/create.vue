<template>
    <div>
        <div class="app-title">
            <div>
                <h1><i class="fa fa-book"></i> Create Course</h1>
            </div>
                            ...
                            <div class="col-md-8 offset-md-2">
                                ...
                                <div v-for="(module, index) in modules">
                                    <div class="form-group">
                                        ...
                                        <input :class="{'is-invalid': errors.hasOwnProperty(`modules.${index}.name`)}" type="text" name="modules[][name]" :id="`duration-${index}`" class="form-control">
                                        <ErrorMessage :error-key="`modules.${index}.name`" :errors="errors"/>
                                    </div>
                                    <div class="text-right">
                                        <button type="button" v-if="modules.length == (index + 1)" @click="addModule" class="btn btn-xs btn-primary">Add More</button>
                                        <button v-if="index" @click="modules.splice(index, 1)" type="button" class="btn btn-xs btn-danger">Delete</button>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delivery_center" id="delivery_center" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="number_of_lecture">Number Of Lecture</label>
                                    <input type="text" name="number_of_lecture" id="number_of_lecture" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="class_per_week">Class Per Week</label>
                                    <input type="text" name="class_per_week" id="class_per_week" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" v-selected v-model.number="course.discount_percent" name="discount_percentage" id="discount" class="form-control">
                                </div>
                                <div class="form-group">
...
<script>
    ...
    export default {
        ...
        computed: {
            discountGiven(){
                return Math.round(
                    this.course.price.percentOf(this.course.discount_percent)
                )
            },
            priceAfterDiscount(){
        ...
        components: {
            ErrorMessage, Datepicker, VueSelect, ProgressBar, CreateCategoryTree
        },
        methods: {
            create({ target }){
                let vm = this
