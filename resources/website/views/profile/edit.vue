<template>
    <div class="row">
        <div class="col-md-6">
            <form @submit.prevent="update" v-if="!isEmpty(user)">
        ...
        <div class="col-md-5 col-md-offset-1">
            <form @submit.prevent="changePassword">
                <strong class="w-100">Change Password</strong>
                <div class="form-group">
                    <label for="old_password">Old Password</label>
                    <div class="input-box">
                        <input type="password" id="old_password" name="old_password" class="input-text w-100">
                        <ErrorMessage :errors="errors" error-key="old_password"></ErrorMessage>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password">New Password</label>
                    <div class="input-box">
                        <input type="password" id="password" name="password" class="input-text w-100">
                        <ErrorMessage :errors="errors" error-key="password"></ErrorMessage>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password_confirmation">Confirm Password</label>
                    <div class="input-box">
                        <input type="password" id="password_confirmation" name="password_confirmation" class="input-text w-100">
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            changePassword({ target }){
                Profile.updatePassword(target).then(() => {
                    this.clearErrors()
                }).catch(({ response }) => {
                    this.errors = response.data.errors
